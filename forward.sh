...
sudo iptables -t nat -A POSTROUTING -p tcp --match multiport --dports  4444 -j MASQUERADE 
sudo iptables -t nat -A PREROUTING -p tcp --match multiport --dports  7766 -j DNAT --to-destination $IP
